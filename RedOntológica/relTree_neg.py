...
def relaciones(tab, dom):
    ...
    while r<len(tab):
        ...
        try:
            ###########negaciones##############
            if tab[r]['eti']=="NEG" or tab[r]["texto"]=="sin":
                    ...
                    if r==len(tab) or tab[r]['texto']=='.':
                        ...
                        if bandera==True:
                            for rango in rangos:
                                ...
                                ###llama a la ventana    
                                dominio=dom
                                relacion="http://www.diabetes-mexico.org/red#presentaSintoma" #todas las relaciones van sobre la red
                                ...
                                sal1.write(dom+"\tpresentaSintoma\t"+ rango.capitalize() +"\n")
                                sal.write(dom+"\tpresentaSintoma\t"+ rango.capitalize()+"\n")
                        break        
                    elif  tab[r]['eti']!='NPHRASE' and tab[r]['eti']!='sintoma' and tab[r]['eti']!='PUNCT':
                        bandera=False
...
sal=open('etiquetas_propuesta_treefinal.txt','w', encoding='utf-8')
sal1=open("relaciones_propuestas_treefinal.txt",'w', encoding='utf-8')
