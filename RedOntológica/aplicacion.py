# -*- coding: utf-8 -*-
"""
Created on Sat Apr  3 17:40:47 2021
...
class App(tk.Frame):
    def __init__(self, master, dominios, relaciones, rangos):
        ...
        self.registra=tk.Button(self, text="Registra")
        #self.registra["text"]="Registra"
        self.registra["command"]=self.print_contents

        self.registra.pack(side="left")
    ...
    def print_contents(self):
        ...
        if IRIS[domi]!=None :
            ...
            if link==onto_enfe.base_iri:
                with onto_enfe:
                    dominioTriple=onto_enfe.Padecimiento(n_obj)
                    onto_enfe.save()
        ...
        try:
            ...
            with onto_dato:
                ...
                setattr(dominioTriple, nombre, [nuevo_rango])
                onto_dato.save()
        except ValueError: 
